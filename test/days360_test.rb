...
class Days360Test < Test::Unit::TestCase
  ...
  test "some more calculations" do
    ...
    assert_equal 120, Days360::Days360.eu_method(date_a, date_b), "Deutsche (kaufmaennische) Zinsmethode"
  end
  ...
  test "days360_EU should give same result as Open Office Calc" do
    ...
    result = compare_gem_to_reference(:eu_method, reference_results)
